export const SERVICES = [
  { icon: "🌐", cat: "Development", name: "AI-Integrated Web Dev", desc: "Custom business, portfolio, e-commerce websites with built-in AI search & automation.", isAI: true },
  { icon: "📱", cat: "Development", name: "Autonomous App Dev", desc: "Mobile & web apps with embedded AI models, real-time processing and intelligent UI.", isAI: true },
  { icon: "🎨", cat: "Design", name: "AI-Assisted Branding", desc: "Data-driven brand identity and logo generation balanced with human creative mastery.", isAI: true },
  { icon: "✏️", cat: "Design", name: "AI-Gen Social Creative", desc: "Automated high-end social media assets, ad creatives, and dynamic visual content.", isAI: true },
  { icon: "🖥️", cat: "Design", name: "Intelligent UI/UX", desc: "Predictive user interfaces, behavioral design, and AI-driven user flow optimization.", isAI: true },
  ...
  { icon: "⚡", cat: "AI & Automation", name: "Automation & CRM Setup", desc: "Email/SMS/WhatsApp flows, CRM setup, Google Analytics & Meta Pixel dashboards.", isAI: true },
  { icon: "🤖", cat: "AI & Automation", name: "AI Chatbots & Assistants", desc: "FAQ bots, lead-qualifying bots, support bots integrated with WhatsApp, forms & CRM.", isAI: true },
  { icon: "✨", cat: "AI & Automation", name: "AI-Enhanced Design", desc: "AI-assisted logo variants, brand-kit elements, AI-generated social creatives & ad templates.", isAI: true },
  { icon: "🧠", cat: "AI & Automation", name: "AI-Driven Marketing & Ads", desc: "AI ad copy, creative variants, A/B test suggestions, AI content calendar.", isAI: true },
  { icon: "📈", cat: "AI & Automation", name: "AI Analytics & Automation", desc: "Predictive dashboards, AI-driven workflows, auto-tagging, auto-segmentation, AI reporting.", isAI: true },
  { icon: "🔮", cat: "AI & Automation", name: "AI Product Features & UX", desc: "Personalised UI/UX, smart AI/NLP search, AI-assisted wireframe generation.", isAI: true },
  ...
  { icon: "🎙️", cat: "AI & Automation", name: "Voice AI & IVR Agents", desc: "AI phone agents for bookings, FAQs, order status. CRM & calendar integration.", isAI: true },
